 ...
 * Usage: npx tsx scripts/update-brand-asset.ts <assetId> <field> <value>
 */
...
async function updateAsset() {
  ...
  if (!assetId || !field) {
    console.log('Usage: npx tsx scripts/update-brand-asset.ts <assetId> <field> <value>')
    console.log('Example: npx tsx scripts/update-brand-asset.ts 696afb6cb1804801c01e3e51 subcategory "Team"')
    process.exit(1)
  }
