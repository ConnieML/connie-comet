...
export interface Page {
  ...
  title: string;
  /**
   * Choose how this page should be displayed
   */
  layoutType?: ('standard' | 'landing') | null;
  hero: {
...
export interface HeroBlock {
  ...
  backgroundEffect?: ('dotMatrix' | 'gradient' | 'none') | null;
  id?: string | null;
...
export interface RawHTMLBlock {
  /**
   * Raw HTML will be rendered directly on the page. Use with caution.
   */
  html: string;
  /**
   * CSS class to wrap around your HTML (e.g., "container mx-auto")
   */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "WaitlistLandingBlock".
 */
export interface WaitlistLandingBlock {
  id?: string | null;
  blockName?: string | null;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "WaitlistStaticBlock".
 */
export interface WaitlistStaticBlock {
  id?: string | null;
  blockName?: string | null;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "WaitlistLandingBlock_select".
 */
export interface WaitlistLandingBlockSelect<T extends boolean = true> {
  id?: T;
  blockName?: T;
}
/**
...
export interface Footer {
  ...
  navItems?:
    ...
    | null;
  /**
   * Footer columns with links (e.g., "Connie Platform", "Resources", "Quick Links")
   */
  footerColumns?:
    | {
        title: string;
