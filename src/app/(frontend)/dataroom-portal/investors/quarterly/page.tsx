...
export default function QuarterlyDocumentsPage() {
  ...
  const loadDocuments = async () => {
    try {
      ...
      const mediaResponse = await fetch('/api/media?where[isDataroomDocument][equals]=true&where[documentCategory][equals]=quarterly')
      if (mediaResponse.ok) {
      ...
      const externalResponse = await fetch('/api/external-documents?where[documentCategory][equals]=quarterly')
    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-slate-50 to-slate-200 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-slate-600 mb-6">Please log in to access quarterly business review documents.</p>
      ...
      <div className="container mx-auto px-6 py-16 relative z-10">
        ...
        <div className="mb-8">
          <div className="flex items-center space-x-2 text-sm text-slate-600">
            ...
            <span>→</span>
            <span className="text-slate-800 font-medium">Quarterly Business Review</span>
          </div>
        </div>
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            Go-to-market strategy and quarterly performance metrics
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          {documents.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-slate-600">Quarterly business review documents will appear here when added by administrators.</p>
            </div>
          ) : (
