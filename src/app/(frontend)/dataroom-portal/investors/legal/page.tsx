...
export default function LegalDocumentsInvestorPage() {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-slate-50 to-slate-200 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-slate-600 mb-6">Please log in to access legal documents.</p>
      ...
      <div className="container mx-auto px-6 py-16 relative z-10">
        ...
        <div className="mb-8">
          <div className="flex items-center space-x-2 text-sm text-slate-600">
            ...
            <span>→</span>
            <span className="text-slate-800 font-medium">Legal Documents</span>
          </div>
        </div>
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            Contracts, compliance documents, regulatory filings
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          {documents.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-slate-600">Legal documents will appear here when added by administrators.</p>
            </div>
          ) : (
