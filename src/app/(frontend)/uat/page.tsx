...
export default function ConnieUATPage() {
  return (
      ...
      <div className="bg-white py-20 md:py-28">
        <div className="container mx-auto px-6">
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-semibold text-twilio-navy mb-6 leading-tight flex items-center justify-center gap-4">
              <span className="text-3xl md:text-4xl">🧪</span>
              <span>Help Us Build a More Connected<br />Future for Aging</span>
            </h1>
            <p className="text-xl text-twilio-muted max-w-2xl mx-auto leading-relaxed mb-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                ...
                className="inline-block py-3 px-8 bg-white hover:bg-twilio-bg-subtle text-twilio-navy font-semibold rounded-md border border-twilio-border transition-colors"
              >
                Learn More
              </Link>
            </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
              ...
              <div className="bg-white border border-twilio-border rounded-lg p-6 text-center shadow-[0_1px_3px_rgba(0,0,0,0.08)] hover:shadow-[0_4px_6px_rgba(0,0,0,0.12)] transition-shadow duration-300">
                ...
                <a
                  href="mailto:?subject=Connie%20UAT%20Program%20-%20Community-Based%20Care%20Technology&body=I%20thought%20you%20might%20be%20interested%20in%20the%20Connie%20UAT%20program%20for%20community-based%20organizations.%20Learn%20more%3A%20https%3A%2F%2Fconnie.one%2Fuat"
                  className="inline-block w-full py-3 px-6 bg-white hover:bg-twilio-bg-subtle text-twilio-navy font-semibold rounded-md border border-twilio-border transition-colors"
                >
                  Email This Page
                </a>
